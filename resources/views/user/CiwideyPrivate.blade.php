  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Ciwidey</span>
      </div>
    </li>
  </ol>
</nav>
  ...
  <div class="max-w-7xl mx-auto space-y-4">
    @php
      $itinerary = [
        ...
        'Transfer menuju ke Ciwidey',
        'Mengunjungi Kawah Putih. Di sana Anda dapat menikmati keindahan kawah yang mempesona',
        'Makan siang di local resto.',
        'Mengunjungi Glamping Lakeside Situ Patenggang (Phinisi Resto)/Ranca Upas & Perkebunan Teh Rancabali',
        'Optional: Mengunjungi Kawah rengganis & Jembatan Gantung rengganis (biaya tiket terpisah) Setelah selesai, kembali menuju Kota Bandung',
        'Tiba kembali di Bandung, Bonus City tour, visit: Gedung Sate, Gedung Merdeka, Alun-alun Bandung dan Braga untuk foto stop atau mengunjungi MASJID AL JABAR (Jika waktu mencukupi)',
        'Shopping tour: Cibaduyut, Factory Outlet Jl. Riau Area / Teras Cihampelas (tidak wajib)',
        'Setelah selesai, transfer kembali ke hotel/Stasiun KCIC/Stasiun KAI/Pool Shutle-Bus, end of service.(Durasi Tour Max. 12 Jam)',
        ];
    @endphp
...
<script>
  ...
  function getHarga(peserta) {
    if (peserta >= 45 && peserta <= 50) return 335000;
    if (peserta >= 26 && peserta <= 30) return 380000;
    if (peserta >= 20 && peserta <= 25) return 405000;
    if (peserta >= 15 && peserta <= 18) return 345000;
    if (peserta >= 13 && peserta <= 14) return 335000;
    if (peserta >= 11 && peserta <= 12) return 360000;
    if (peserta >= 7 && peserta <= 10) return 400000;
    if (peserta >= 5 && peserta <= 6) return 365000;
    if (peserta >= 3 && peserta <= 4) return 465000;
    return 565000; // default 2 orang
  }
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div class="bg-green-50 border border-green-200 shadow-sm rounded-xl p-6">
      ...
      <ul class="space-y-2 text-gray-700 text-sm md:text-base">
        ...
        <li class="flex items-start">
          <span class="text-green-500 mr-2">•</span>
          <span>Tiket masuk objek wisata: KawahPutih (include shuttle), Glamping lakeside Situ Patenggang/Ranca Upas, kebun teh Rancabali</span>
        </li>
        <li class="flex items-start">
          <span class="text-green-500 mr-2">•</span>
    ...
    <div class="bg-gray-50 border border-gray-200 shadow-sm rounded-xl p-6">
      ...
      <ul class="space-y-2 text-gray-700 text-sm md:text-base">
        ...
        <li class="flex items-start">
          <span class="text-red-500 mr-2">•</span>
          <span>Foreigner additional: Tiket Kawah PutihRp. 70.000/pa</span>
        </li>
        <li class="flex items-start">
          <span class="text-red-500 mr-2">•</span>
          <span>Glamping Lakeside Rp. 35.000/pax</span>
        </li>
        <li class="flex items-start">
          <span class="text-red-500 mr-2">•</span>
          <span>Ranca Upas Rp. 30.000/pax</span>
        </li>
        <li class="flex items-start">
          <span class="text-red-500 mr-2">•</span>
          <span>Additional Kawah Rengganis & Jembatan gantung Rp. 100.000/orang</span>
        </li>
      </ul>
    </div>
