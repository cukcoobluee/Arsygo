  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Bandung</span>
      </div>
    </li>
  </ol>
</nav>
  ...
  <div class="max-w-7xl mx-auto space-y-4">
    @php
      $itinerary = [
        ...
        'City Tour Bandung mengunjungi Gedung Sate, Museum Gedung Sate, Museum Geologi & Monumen Perjuangan Bandung',
        'Kemudian mengunjungi wisata sejarah Monumen Perjuangan Tugu Lautan Api, Jl. Asia Africa, Nol (0) Kilometer Bandung, Hotel Savoy Homan, Gedung Merdeka, Alun-alun Bandung dan Jl. Braga',
        'Sore hari anda bisa shopping di Cihampelas, Rumah Mode, Factory Outlet Jl. Riau Area (tidak wajib)',
        'Setelah selesai, transfer Kembali menuju Stasiun KCIC / hotel/Stasiun Bandung/ Bus Terminal, end of service.(Durasi Tour Max. 12 Jam)',
        ];
    @endphp
...
<div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 ml-10  gap-6 px-20">
  @php
    $destinations = [
      ...
      [
        'name' => 'Monumen Perjuangan Bandung',
        'image' => 'img/caurasel3.png'
      ],
      [
        'name' => 'Monumen Perjuangan Tugu Lautan Api',
        'image' => 'img/caurasel3.png'
      ],
      [
        'name' => 'Jl. Asia Afrika',
      ...
      [
        'name' => 'Nol(0) Kilometer Bandung',
        'image' => 'img/caurasel3.png'
      ],
      [
        'name' => 'Hotel Savoy Homan',
        'image' => 'img/caurasel3.png'
      ],
      [
        'name' => 'Gedung Merdeka',
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div class="bg-gray-50 border border-gray-200 shadow-sm rounded-xl p-6">
      ...
      <ul class="space-y-2 text-gray-700 text-sm md:text-base">
        ...
        <li class="flex items-start">
          <span class="text-red-500 mr-2">•</span>
          <span>High season surcharge periode: Peak Season, Liburan Sekolah, Lebaran, Natal dan Tahun Baru (+35%)</span>
        </li>
        <li class="flex items-start">
          <span class="text-red-500 mr-2">•</span>
          <span>Additional Lunch/Diner 65.000/orang</span>
        </li>
      </ul>
    </div>
