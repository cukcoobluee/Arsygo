  ...
  <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
    ...
    <li aria-current="page">
      <div class="flex items-center">
        ...
        <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Lembang</span>
      </div>
    </li>
  </ol>
</nav>
...
<!-- Gambar -->
  <img src="{{ asset('img/lembang.jpg') }}" 
       alt="Private Trip Lembang"
...
<section class="px-6 sm:px-10 md:px-20 py-10">
  ...
  <div class="max-w-7xl mx-auto space-y-4">
    @php
      $itinerary = [
        'Dijemput di Hotel/Stasiun/Terminal Bandung',
        'Pilih 2 Destinasi Wisata Favorit',
        'Makan siang di restoran lokal',
        'City Tour Bandung: Gedung Sate, Braga, Alun-alun, Masjid Al-Jabar',
        'Shopping spot: Rumah Mode, PVJ, FO Riau/Dago, Cihampelas',
        'Transfer kembali ke hotel/stasiun/terminal',
      ];
    @endphp
  ...
  @php
    $destinations = [
      [
        ...
        'image' => 'img/tangkuban.png'
      ],
      [
        'name' => 'Sari Ater Hotspring',
        'image' => 'img/sari ater.jpg'
      ],
      [
        'name' => 'De Castelo',
        'image' => 'img/castelo.jpeg'
      ],
      [
        'name' => 'Floating Market Lembang',
        'image' => 'img/floating.jpeg'
      ],
      [
      ...
      [
        'name' => 'Kota Mini Lembang',
        'image' => 'img/kotamini.jpg'
      ],
      [
        'name' => 'Lembang Wonderland',
...
<script>
  ...
  function getHarga(peserta) {
    if (peserta >= 45 && peserta <= 50) return 320000;
    if (peserta >= 26 && peserta <= 30) return 365000;
    if (peserta >= 20 && peserta <= 25) return 395000;
    if (peserta >= 15 && peserta <= 18) return 330000;
    if (peserta >= 13 && peserta <= 14) return 320000;
    if (peserta >= 11 && peserta <= 12) return 345000;
    if (peserta >= 7 && peserta <= 10) return 385000;
    if (peserta >= 5 && peserta <= 6) return 350000;
    if (peserta >= 3 && peserta <= 4) return 450000;
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div class="bg-green-50 border border-green-200 shadow-sm rounded-xl p-6">
      ...
      <ul class="space-y-2 text-gray-700 text-sm md:text-base">
        ...
        <li class="flex items-start">
          <span class="text-green-500 mr-2">•</span>
          <span>Pilih 2 Destinasi Tiket masuk objek wisata sesuai pilihan</span>
        </li>
        <li class="flex items-start">
          <span class="text-green-500 mr-2">•</span>
    ...
    <div class="bg-gray-50 border border-gray-200 shadow-sm rounded-xl p-6">
      ...
      <ul class="space-y-2 text-gray-700 text-sm md:text-base">
        ...
        <li class="flex items-start">
          <span class="text-red-500 mr-2">•</span>
          <span>Foreigner additional: Tangkuban Perahu 270.000 (weekend) Rp. 170.000 (weekday)</span>
        </li>
        <li class="flex items-start">
          <span class="text-red-500 mr-2">•</span>
          <span>Jika Anda membutuhkan tiket WHOOSH, silahkan kontak admin kami</span>
        </li>
      </ul>
    </div>
