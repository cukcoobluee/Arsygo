    ...
    <div class="max-w-screen-lg mx-auto px-4 sm:px-6 py-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            @forelse($hotels as $hotel)
                <div class="p-6 bg-white rounded-2xl shadow flex items-center w-full max-w-xl mx-auto">
                    {{-- Logo Hotel --}}
                    ...
                    <div class="flex flex-col justify-between">
                        ...
                        <a href="{{ route('hotel.booking.create', $hotel->id) }}" 
                           class="mt-3 px-4 py-2 bg-yellow-500 text-white text-sm font-semibold rounded-full hover:bg-yellow-600 transition">
                            Dapatkan sekarang
                        </a>
                    </div>
                </div>
